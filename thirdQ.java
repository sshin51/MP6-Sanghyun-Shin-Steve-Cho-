...
public class thirdQ extends AppCompatActivity {
    ...
    private int maxPressCounter = 6;
    private String[] keys = {"E","A", "G","L", "U", "I", "E"};
    private String textAnswer = "LEAGUE";
    ...
    private void doValidate() {
        ...
        if(editText.getText().toString().equals(textAnswer)) {
            Toast.makeText(thirdQ.this, "Correct", Toast.LENGTH_SHORT).show();
            editText.setText("");
            Intent a = new Intent(thirdQ.this, fourthQ.class);
            startActivity(a);
        } else {
            wrongCounter--;
            if (wrongCounter == 0) {
                Intent b = new Intent(thirdQ.this, Fail.class);
                startActivity(b);
            }
            Toast.makeText(thirdQ.this, "Wrong! Lives: " + String.valueOf(wrongCounter), Toast.LENGTH_SHORT).show();
            editText.setText("");
        }
        keys = shuffleArray(keys);
